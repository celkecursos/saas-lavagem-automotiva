...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        /*
         * Atributos do Celke Wash Club — acrescentados por cima do que a
         * lucascudo/laravel-pt-BR-localization publica. Republicar o pacote
         * (vendor:publish --force) sobrescreve este arquivo e derruba este
         * bloco; se isso acontecer, é só recolocá-lo.
         */
        'email' => 'e-mail',
        'cpf' => 'CPF',
        'document' => 'CNPJ',
